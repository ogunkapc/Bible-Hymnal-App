class ImageConstants {
  ...
  //! App Icon
  static String appLogo = '$logoPath/app_logo.png';

  //! Icons
  // Bottom Navigation Bar Icons
  static String iconHome = '$iconPath/home_icon.png';
  static String iconBible = '$iconPath/bible_icon.png';
  static String iconHymn = '$iconPath/music_book.png';
